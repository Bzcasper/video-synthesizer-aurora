    ...
    >
        ...
        <Textarea
          ...
          className={`h-[144px] w-full bg-white/5 border-white/10 text-white focus:ring-aurora-blue 
                    hover:border-aurora-blue/50 transition-golden ${
                      ...
                      isTooShort ? 'border-yellow-500 focus:border-yellow-500 focus:ring-yellow-500' :
                      validation.error ? 'border-red-500 focus:border-red-500 focus:ring-red-500' :
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-start gap-2 max-w-[80%]">
          ...
          <p id="description-hint" className={`text-sm ${isTooShort ? 'text-yellow-500' : 'text-gray-400'}`}>
            {isTooShort 
