  ...
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-aurora-black overflow-hidden">
        ...
        {/* Aurora Effect 3 */}
        <div className="absolute bottom-0 left-[20%] w-[400px] h-[400px] bg-gradient-radial from-green-500/20 via-transparent to-transparent opacity-40 blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto px-4 z-10 py-16">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-8">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Aurora Video Synthesizer uses advanced AI to generate high-quality videos from your text descriptions. Create mind-blowing content in minutes, not hours.
            </p>
            ...
            <div className="mt-8 flex items-center gap-2 text-gray-400 text-sm animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-green-500/20 text-green-400">✓</span>
              <span>No sign-up required for first generation</span>
              
              <span className="ml-4 inline-flex items-center justify-center h-6 w-6 rounded-full bg-green-500/20 text-green-400">✓</span>
              <span>High-quality AI renders</span>
            </div>
          </div>
          
          <div className="lg:w-1/2 mt-12 lg:mt-0 animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <div className="relative rounded-lg overflow-hidden shadow-[0_0_50px_rgba(0,123,255,0.3)]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="h-20 w-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-white/20 transition-all cursor-pointer group">
                    <div className="h-16 w-16 rounded-full bg-gradient-to-br from-aurora-purple to-aurora-blue flex items-center justify-center">
                      <svg className="w-8 h-8 text-white ml-1 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-black/80 backdrop-blur-sm rounded-lg p-4 border border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-aurora-white">AI Video Generation in Progress</span>
                </div>
