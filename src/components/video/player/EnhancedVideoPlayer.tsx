...
export function EnhancedVideoPlayer({ src, title, poster, onError, className }: VideoPlayerProps) {
      ...
      >
        ...
        {hasError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 text-white p-4">
            ...
            <p className="text-center text-sm text-gray-400 mb-4">The video file could not be played.</p>
