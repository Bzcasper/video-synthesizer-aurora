...
export function VideoProcessingStatus({
  ...
  return (
    <Card
      className={`bg-gradient-to-br from-aurora-black to-black/80 border border-white/10 ${className}`}
    >
      <CardContent className="p-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div>
            <h3 className="text-lg font-medium text-aurora-white">
              {videoTitle}
            </h3>
          ...
          <div
            className={`px-3 py-1 rounded-full text-sm font-medium border mt-2 sm:mt-0 
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm font-medium text-aurora-blue">
