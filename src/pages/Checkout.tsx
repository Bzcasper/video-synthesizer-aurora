              ...
              <Card className="glass-panel bg-gradient-to-br from-aurora-blue/10 to-aurora-purple/5 border-aurora-blue/30 p-6">
                ...
                <div className="bg-white/5 rounded-lg p-3 border border-white/10">
                  <p className="text-sm text-gray-300">
                    Need enterprise features like custom branding, bulk processing, or API access?
                  </p>
                  <a 
              ...
              <Card className="glass-panel p-6 border-white/10">
                ...
                >
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <Label htmlFor="monthly" className="flex flex-1 justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="annual" className="flex flex-1 justify-between">
                      <div>
                        <span>Annual billing</span>
                        <span className="ml-2 bg-green-500/20 text-green-300 text-xs py-0.5 px-1.5 rounded">Save 20%</span>
                      </div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between font-semibold">
                    <span>Total ({planDetails[selectedPlan].billingCycle})</span>
                    <span>{planDetails[selectedPlan].price}</span>
                  </div>
                </div>
