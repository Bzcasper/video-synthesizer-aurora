    ...
    const fetchUserData = async () => {
      try {
        ...
        if (session) {
          ...
          if (usageData) {
            setUsage({
              usedCount: usageData.video_count ?? 0,
        ...
        toast({
          ...
          description:
            "We couldn't load your subscription and usage information.",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
  ...
  const handleCreateVideo = () => {
    ...
    if (subscription.tier === "free" && usage.usedCount >= usage.limit) {
      toast({
        ...
        description:
          "You've reached your 5 videos/month limit. Upgrade to Pro for unlimited videos.",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <div className="space-y-6 px-4 w-full max-w-[2000px] mx-auto">
      ...
      {subscription.tier === "free" && (
        <div className="mb-8">
          <Card className="glass-panel border-aurora-purple/30 p-4 sm:p-6">
            ...
            <CardFooter className="pt-0">
              <p className="text-xs text-gray-400">
                {usage.usedCount >= usage.limit
                  ...
                  : `${
                      usage.limit - usage.usedCount
                    } videos remaining this month.`}
              </p>
            </CardFooter>
          </Card>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card className="glass-panel h-full border-white/10 p-4 sm:p-6">
            <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="glass-panel border-white/10 p-4 sm:p-6">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                ...
                <CardDescription>
                  {subscription.tier === "free"
                    ? "Basic AI styles available"
                    : "All premium AI styles unlocked"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {subscription.tier === "free" ? "Standard" : "Fast"}
                      </span>
                    </div>
                    <Progress
                      value={
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {subscription.tier === "free" ? "720p" : "4K"}
                      </span>
                    </div>
                    <Progress
