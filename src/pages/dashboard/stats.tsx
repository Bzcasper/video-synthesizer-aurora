    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-fib-4">
        <div className="glass-panel p-fib-4 rounded-lg">
          <div className="flex flex-col">
            ...
            <div className="flex items-end justify-between">
              <span className="text-2xl font-bold text-aurora-white">
                32/500
              </span>
            ...
            <div className="mt-2 h-1.5 bg-black/30 rounded-full overflow-hidden">
              <div
                className="bg-gradient-to-r from-aurora-purple to-aurora-blue h-full rounded-full"
                style={{ width: "6.4%" }}
              ></div>
            </div>
          </div>
        ...
        <div className="glass-panel p-fib-4 rounded-lg">
          <div className="flex flex-col">
            ...
            <div className="mt-2 h-1.5 bg-black/30 rounded-full overflow-hidden">
              <div
                className="bg-gradient-to-r from-aurora-blue to-aurora-green h-full rounded-full"
                style={{ width: "2.56%" }}
              ></div>
            </div>
          </div>
        ...
        <div className="glass-panel p-fib-4 rounded-lg">
          <div className="flex flex-col">
            ...
            <div className="mt-2 h-1.5 bg-black/30 rounded-full overflow-hidden">
              <div
                className="bg-gradient-to-r from-aurora-green to-aurora-purple h-full rounded-full"
                style={{ width: "50%" }}
              ></div>
            </div>
          </div>
      ...
      <div className="glass-panel p-fib-4 rounded-lg">
        <div className="flex items-center gap-3 mb-fib-4">
          <CustomIcon
            name="stats"
            className="h-fib-3 w-fib-3 text-aurora-blue"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-fib-4">
        <div className="glass-panel p-fib-4 rounded-lg">
          <div className="flex items-center gap-3 mb-fib-4">
            <CustomIcon
              name="batch"
              className="h-fib-3 w-fib-3 text-aurora-purple"
            />
        ...
        <div className="glass-panel p-fib-4 rounded-lg">
          <div className="flex items-center gap-3 mb-fib-4">
            <CustomIcon
              name="processing"
              className="h-fib-3 w-fib-3 text-aurora-green"
            />
            <h2 className="text-xl font-orbitron font-bold text-gradient bg-gradient-glow">
