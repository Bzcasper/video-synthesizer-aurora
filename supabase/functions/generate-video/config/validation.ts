...
export const videoSettingsSchema = z.object({
  resolution: z
    ...
    .optional()
    .default([
      VIDEO_SETTINGS.RESOLUTIONS.FULL_HD[0],
      VIDEO_SETTINGS.RESOLUTIONS.FULL_HD[1],
    ]),
  fps: z
    .number()
    .int()
  ...
  duration: z
    .number()
    .min(VIDEO_SETTINGS.DURATION.MIN)
    .max(VIDEO_SETTINGS.DURATION.MAX)
    .optional()
    .default(VIDEO_SETTINGS.DURATION.DEFAULT),
  enhanceFrames: z.boolean().optional().default(true),
  style: z
    .enum([
  ...
  outputFormat: z
    .enum([VIDEO_SETTINGS.FORMATS.MP4, VIDEO_SETTINGS.FORMATS.WEBM])
    .optional()
    .default(VIDEO_SETTINGS.FORMATS.MP4),
  quality: z
    .enum([
      VIDEO_SETTINGS.QUALITY.DRAFT,
